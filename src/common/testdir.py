...
def setup_dir(test_dir_name, images_to_test):
    ...
    command = "exiftool -overwrite_original -FocalLength=4 {}/*.jpg".format(images_dir)
    os.system(command)
    command = "exiftool -overwrite_original -FocalLengthIn35mmFormat=30.45 {}/*.jpg".format(images_dir)
    os.system(command)
    command = "exiftool -overwrite_original -Make='test' {}/*.jpg".format(images_dir)
    os.system(command)
    command = "exiftool -overwrite_original -Model='test' {}/*.jpg".format(images_dir)
    os.system(command)
